...
# CHANGED: Import ResNet50 and its specific preprocessing function
...
# CHANGED: ResNet works best with its own preprocessing function, not rescale=1./255
...
# CHANGED: Instantiating ResNet50
...
# ResNet50 is deeper than MobileNet, but freezing up to 120 is still a safe starting point
freeze_until = 120
