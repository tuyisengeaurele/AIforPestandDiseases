...
MODEL_PATH = "sericulture_efficientnetb4_model.keras"
CONFUSION_MATRIX_FILE = "confusion_matrix_efficientnet.png"
PERFORMANCE_PLOT_FILE = "performance_plot_efficientnet.png"
...
print("MODEL PERFORMANCE (EfficientNetB4)")
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', # Changed color map slightly to distinguish
            xticklabels=class_names,
            yticklabels=class_names)
plt.ylabel('Actual Label')
plt.xlabel('Predicted Label')
plt.title(f'EfficientNetB4 Confusion Matrix (Global F1: {global_f1:.2f})')
plt.tight_layout()
...
plt.title('EfficientNetB4 F1-score per class')
