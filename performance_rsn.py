...
# CHANGED: Import specific preprocessing for ResNet50
...
# CHANGED: Updated model path to the new ResNet model
MODEL_PATH = "sericulture_resnet50_model.keras"

# CHANGED: Updated output filenames so they are distinct
...
# CHANGED: Use preprocess_input instead of rescale=1.0/255 to match training
