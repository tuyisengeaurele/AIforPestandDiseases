...
MODEL_NAME = "sericulture_efficientnetb4_model.keras"
...
if __name__ == "__main__":
    ...
    root.title("Sericulture Pest and Disease Detector (EfficientNetB4)")
    ...
    title_label = tk.Label(
        ...
        text="Sericulture EfficientNetB4 Detector",
